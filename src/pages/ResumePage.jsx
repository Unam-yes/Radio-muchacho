...
const ITEMS = [
    { id: "i", badge: "I", title: "VIAJE A JAPÓN", subtitle: "", rank: 1 },
    { id: "ii", badge: "II", title: "ECHAR A LUIS", subtitle: "", rank: 2 },
    { id: "iii", badge: "III", title: "", subtitle: "", rank: 3 },
    { id: "iv", badge: "IV", title: "", subtitle: "", rank: 4 },
];

const EDUCATION_DATA = [
    { index: "01", title: "", status: "", detail: "" },
    { index: "02", title: "", status: "", detail: "" },
    { index: "03", title: "", status: "", detail: "" },
];
      ...
      `}</style>
            ...
            <div className="resume-overlay">
                <div className="resume-stack">
                    <div className={`resume-list-tag${mounted ? " mounted" : ""}`}></div>
                            ...
                            <div className="resume-card">
                                ...
                                <div className="resume-card-inner">
                                    ...
                                    <div className="resume-rank">
                                        <div className="resume-rank-label"> </div>
                ...
                {active === 0 && (
                    <div className="resume-detail-panel">
                        <div className="resume-detail-top">
                            ...
                            <div className="resume-detail-top-title"></div>
                ...
                {active === 1 && (
                    <div className="resume-detail-panel">
                        ...
                        <div className="resume-detail-bottom">
                            <div className="resume-detail-bottom-title"></div>
